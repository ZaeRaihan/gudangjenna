...
<body>
    ...
    <div class="content">
        <div class="container-fluid">
            <!------- HEADER ------->
            <h1 class="page-header">Inventori Pemasukan Barang Reject
                <br><br><br>
                        ...
                        <tr class="data-row">
                            ...
                            <td>
                                <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                    ...
                                    <form action="kirim_gudangreject.php" method="post" style="margin: 0;">
                                        <input type="hidden" name="idbarang_reject"
                                            value="<?= $row["idbarang_reject"]; ?>">
                                        <button type="submit" class="btn btn-warning"
                                            onclick="return confirm('Apakah Anda ingin mengirim barang tersebut?');">Gudang
                                            Reject</button>
                                    </form>
                                </div>
                            </td>
