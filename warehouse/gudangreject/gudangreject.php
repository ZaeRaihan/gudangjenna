...
$query = "SELECT * FROM gudangreject $date_filter $search_filter ORDER BY idstock_reject DESC LIMIT $start, $limit";
$gudangreject = query($query);

// Hitung jumlah total records untuk pencarian yang difilter dan rentang tanggal
$totalRecordsSearchDateFilter = count(query("SELECT * FROM gudangreject $date_filter $search_filter"));
$totalPagesSearchDateFilter = ceil($totalRecordsSearchDateFilter / $limit);

// Hitung jumlah total catatan untuk filtered date range
$totalRecordsDateFilter = count(query("SELECT * FROM gudangreject $date_filter"));
...
<head>
    ...
    <title>Gudang Barang Reject</title>
</head>
...
<body>
    ...
    <div class="content">
        <div class="container-fluid">
            <!------- HEADER ------->
            <h1 class="page-header">Gudang Barang Reject
                <br><br><br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="" method="GET" class="form-inline">
                            ...
                            <a href="gudangreject.php" class="btn btn-warning mx-2">Clear</a>
                        </form>
                ...
                <div class="row" style="margin-top: 5px; margin-bottom: 5px">
                    ...
                    <div class="col-md-2 text-right">
                        ...
                        <a href="gudangreject_history.php" class="btn btn-info mx-2" target="_blank">History</a>
                    </div>
                </div>
                            ...
                            <div class="modal-body">
                                ...
                                <form action="proses_tambah.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="kategori" name="kategori" required onchange="checkLainnya('kategori')">
                                        ...
                                        <input type="text" class="form-control mt-2" id="kategori_input" name="kategori_input" style="display: none;" placeholder="Masukkan Kategori">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="lokasi" name="lokasi" required onchange="checkLainnya('lokasi')">
                                        ...
                                        <input type="text" class="form-control mt-2" id="lokasi_input" name="lokasi_input" style="display: none;" placeholder="Masukkan Lokasi">
                                    </div>
                                    <div class="form-group">
                ...
                <div class="table-responsive">
                    <table id="data-table" class="table table-hover">
                        ...
                        <?php foreach ($gudangreject as $row) : ?>
                            ...
                            <tr class="data-row">
                                ...
                                <td>
                                    <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                        ...
                                        <form action="kirim_keluar.php" method="post" style="margin: 0;">
                                            <input type="hidden" name="idstock_reject" value="<?= $row["idstock_reject"]; ?>">
                                ...
                                <td>
                                    <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                        <button type="button" class="btn btn-warning delete-button" data-id="<?= $row["idstock_reject"]; ?>">Hapus</button>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ubahBarangModal<?= $row["idstock_reject"]; ?>" data-id="<?= $row["idstock_reject"]; ?>" data-page="<?= $page; ?>">Ubah</button>
                                        <button type="button" class="btn btn-success copy-button" data-id="<?= $row["idstock_reject"]; ?>">Copy</button>
                                    </div>
                                </td>
                            </tr>

                            <div class="modal fade" id="ubahBarangModal<?= $row["idstock_reject"]; ?>" tabindex="-1" role="dialog" aria-labelledby="ubahBarangModalLabel<?= $row["idstock_reject"]; ?>" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title" id="ubahBarangModalLabel<?= $row["idstock_reject"]; ?>">
                                                Ubah Barang</h3>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="proses_ubah.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="id" value="<?= $row["idstock_reject"]; ?>">
                                                <div class="form-group">
                                                    <label for="kode">Kode Barang</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="kategori" name="kategori" required onchange="checkOtherOption(this);">
                                                        <option value="<?= $row["kategori"]; ?>" <?= ($row["kategori"] == $row["kategori"]) ? "selected" : ""; ?>>
                                                            <?= $row["kategori"]; ?>
                                                        </option>
                                                        <option value="BAG" <?= ($row["kategori"] == "BAG") ? "selected" : ""; ?>>BAG
                                                        </option>
                                                        <option value="BROOCH" <?= ($row["kategori"] == "BROOCH") ? "selected" : ""; ?>>BROOCH
                                                        </option>
                                                        <option value="BUCKET HAT" <?= ($row["kategori"] == "BUCKET HAT") ? "selected" : ""; ?>>
                                                            BUCKET HAT</option>
                                                        <option value="BUNDLING" <?= ($row["kategori"] == "BUNDLING") ? "selected" : ""; ?>>
                                                            BUNDLING</option>
                                                        <option value="CLOTH MASK" <?= ($row["kategori"] == "CLOTH MASK") ? "selected" : ""; ?>>
                                                            CLOTH MASK</option>
                                                        <option value="DRESS" <?= ($row["kategori"] == "DRESS") ? "selected" : ""; ?>>DRESS
                                                        </option>
                                                        <option value="INNER" <?= ($row["kategori"] == "INNER") ? "selected" : ""; ?>>INNER
                                                        </option>
                                                        <option value="OUTER" <?= ($row["kategori"] == "OUTER") ? "selected" : ""; ?>>OUTER
                                                        </option>
                                                        <option value="PANTS" <?= ($row["kategori"] == "PANTS") ? "selected" : ""; ?>>PANTS
                                                        </option>
                                                        <option value="PRAYER SET" <?= ($row["kategori"] == "PRAYER SET") ? "selected" : ""; ?>>
                                                            PRAYER SET</option>
                                                        <option value="QURAN" <?= ($row["kategori"] == "QURAN") ? "selected" : ""; ?>>QURAN
                                                        </option>
                                                        <option value="SANDAL" <?= ($row["kategori"] == "SANDAL") ? "selected" : ""; ?>>SANDAL
                                                        </option>
                                                        <option value="SCARF" <?= ($row["kategori"] == "SCARF") ? "selected" : ""; ?>>SCARF
                                                        </option>
                                                        <option value="SCRUNCHIE" <?= ($row["kategori"] == "SCRUNCHIE") ? "selected" : ""; ?>>
                                                            SCRUNCHIE</option>
                                                        <option value="SHIRT" <?= ($row["kategori"] == "SHIRT") ? "selected" : ""; ?>>SHIRT
                                                        </option>
                                                        <option value="SHOES" <?= ($row["kategori"] == "SHOES") ? "selected" : ""; ?>>SHOES
                                                        </option>
                                                        <option value="SKIRT" <?= ($row["kategori"] == "SKIRT") ? "selected" : ""; ?>>SKIRT
                                                        </option>
                                                        <option value="TOP" <?= ($row["kategori"] == "TOP") ? "selected" : ""; ?>>TOP
                                                        </option>
                                                        <option value="TUNIC" <?= ($row["kategori"] == "TUNIC") ? "selected" : ""; ?>>TUNIC
                                                        </option>
                                                        <!-- Opsi "Other" -->
                                                        <option value="OTHER" <?= ($row["kategori"] == "OTHER") ? "selected" : ""; ?>>
                                                            Other
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group" id="otherKategoriInput">
                                                    ...
                                                    <input class="form-control" type="text" id="otherKategori" name="otherKategori" placeholder="Pilih Other Pada Dropdown Untuk Memasukkan Kategori Lainnya">
                                                </div>
                                                <script>
                                                ...
                                                <div class="form-group">
                                                    <label for="lokasi">Lokasi</label>
                                                    <select class="form-control" id="lokasi" name="lokasi" required onchange="checkOtherOptionLokasi(this);">
                                                        <option value="<?= $row["lokasi"]; ?>" <?= ($row["lokasi"] == $row["lokasi"]) ? "selected" : ""; ?>>
                                                            <?= $row["lokasi"]; ?>
                                                        </option>
                                                        <option value="Karton" <?= ($row["lokasi"] == "Karton") ? "selected" : ""; ?>>Karton
                                                        </option>
                                                        <option value="Rak" <?= ($row["lokasi"] == "Rak") ? "selected" : ""; ?>>Rak</option>
                                                        <option value="Kontainer" <?= ($row["lokasi"] == "Kontainer") ? "selected" : ""; ?>>
                                                            Kontainer</option>
                                                        <option value="Karung" <?= ($row["lokasi"] == "Karung") ? "selected" : ""; ?>>Karung
                                                        </option>
                                                        <!-- Opsi "Other" -->
                                                        <option value="OTHER" <?= ($row["lokasi"] == "OTHER") ? "selected" : ""; ?>>
                                                            Other
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group" id="otherLokasiInput">
                                                    ...
                                                    <input class="form-control" type="text" id="otherLokasi" name="otherLokasi" placeholder="Pilih Other Pada Dropdown Untuk Memasukkan Lokasi Lainnya">
                                                </div>
                                                <script>
                                                ...
                                                <div class="form-group">
                                                    <label for="rak">Rak</label>
                                                    <input type="text" class="form-control" id="rak" name="rak" value="<?= $row["rak"]; ?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="umur">Umur</label>
                                                    <select class="form-control" id="umur" name="umur" required>
                                                        <option value="" disabled>Pilih Umur Barang</option>
                                                        <option value="<?= $row["umur"]; ?>" <?= ($row["umur"] == $row["umur"]) ? "selected" : ""; ?>>
                                                            <?= $row["umur"]; ?>
                                                        </option>
                                                        <option value="0 - 3 BULAN" <?= ($row["umur"] == "0 - 3 BULAN") ? "selected" : ""; ?>>
                                                            0 - 3 BULAN
                                                        </option>
                                                        <option value="4 - 6 BULAN" <?= ($row["umur"] == "4 - 6 BULAN") ? "selected" : ""; ?>>
                                                            4 - 6 BULAN</option>
                                                        <option value="7 - 9 BULAN" <?= ($row["umur"] == "7 - 9 BULAN") ? "selected" : ""; ?>>
                                                            7 - 9 BULAN</option>
                                                        <option value="10 - 12 BULAN" <?= ($row["umur"] == "10 - 12 BULAN") ? "selected" : ""; ?>>
                                                            10 - 12 BULAN</option>
                                                        <option value="13 - 18 BULAN" <?= ($row["umur"] == "13 - 18 BULAN") ? "selected" : ""; ?>>
                                                            13 - 18 BULAN</option>
                                                        <option value="19 - 24 BULAN" <?= ($row["umur"] == "19 - 24 BULAN") ? "selected" : ""; ?>>
                                                            19 - 24 BULAN</option>
                                                        <option value="> 24 BULAN" <?= ($row["umur"] == "> 24 BULAN") ? "selected" : ""; ?>>
                                                            > 24 BULAN</option>
                                                    </select>
                                                </div>
