...
// Query untuk mengambil data dari tabel gudangreject_history dengan urutan terbaru
$sql = "SELECT * FROM gudangreject_history ORDER BY edit_timestamp DESC";
...
if ($rowCount > 10) {
    $deleteSql = "DELETE FROM gudangreject_history ORDER BY edit_timestamp ASC LIMIT " . ($rowCount - 10);
...
<head>
    ...
    <title>History Gudang Barang Reject</title>
</head>

<body>
    <h1 style="text-align: center;">History Gudang Barang Reject</h1>
