...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $idstock_reject = $_POST['id'];
    $page = $_POST['page'];
    $result = ubahBarang($_POST, $idstock_reject);
    if ($result > 0) {
        echo "<script>alert('Data Barang berhasil diubah!');</script>";
        echo "<script>window.location.href = 'gudangreject.php?page=$page';</script>"; // Redirect kembali ke halaman admin
    } else {
