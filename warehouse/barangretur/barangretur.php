                            ...
                            <td>
                                <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                    ...
                                    <button type="button" class="btn btn-success copy-button"
                                        data-id="<?= $row["idbarang_retur"]; ?>">Copy</button>
                                </div>
                            </td>
                        </tr>

                        <div class="modal fade" id="ubahBarangModal<?= $row["idbarang_retur"]; ?>" tabindex="-1"
                            role="dialog" aria-labelledby="ubahBarangModalLabel<?= $row["idbarang_retur"]; ?>"
                            aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
