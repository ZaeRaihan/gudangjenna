...
$barangretur = query("SELECT * FROM barangretur");

// Pagination
$limit = 20;
$page = isset($_GET['page']) ? $_GET['page'] : 1;
$totalRecords = count(query("SELECT * FROM barangretur"));
...
$query = "SELECT * FROM barangretur $date_filter $search_filter ORDER BY idbarang_retur DESC LIMIT $start, $limit";
$barangretur = query($query);

// Hitung jumlah total records untuk pencarian yang difilter dan rentang tanggal
$totalRecordsSearchDateFilter = count(query("SELECT * FROM barangretur $date_filter $search_filter"));
$totalPagesSearchDateFilter = ceil($totalRecordsSearchDateFilter / $limit);

// Hitung jumlah total catatan untuk filtered date range
$totalRecordsDateFilter = count(query("SELECT * FROM barangretur $date_filter"));
...
<body>
    ...
    <div class="content">
        <div class="container-fluid">
            <!------- HEADER ------->
            <h1 class="page-header">Inventori Barang Retur
                <br><br><br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="" method="GET" class="form-inline">
                            ...
                            <a href="barangretur.php" class="btn btn-warning mx-2">Clear</a>
                        </form>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="proses_tambah.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="surat_retur">Surat Retur</label>
                ...
                <div class="table-responsive">
                    <table id="data-table" class="table table-hover">
                        ...
                        <?php foreach ($barangretur as $row) : ?>

                            <tr class="data-row">
                                <td><input type="checkbox" class="print-checkbox" data-id="<?= $row["idbarang_retur"]; ?>">
                                </td>
                                <td><?= $i; ?></td>
                                ...
                                <td>
                                    <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                        <button type="button" class="btn btn-warning delete-button" data-id="<?= $row["idbarang_retur"]; ?>">Hapus</button>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ubahBarangModal<?= $row["idbarang_retur"]; ?>" data-id="<?= $row["idbarang_retur"]; ?>" data-page="<?= $page; ?>">Ubah</button>
                                        <button type="button" class="btn btn-success copy-button" data-id="<?= $row["idbarang_retur"]; ?>">Copy</button>
                                    </div>
                                </td>
                            </tr>

                            <div class="modal fade" id="ubahBarangModal<?= $row["idbarang_retur"]; ?>" tabindex="-1" role="dialog" aria-labelledby="ubahBarangModalLabel<?= $row["idbarang_retur"]; ?>" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title" id="ubahBarangModalLabel<?= $row["idbarang_retur"]; ?>">
                                                Ubah Barang</h3>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="proses_ubah.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label for="surat_retur">Surat Retur</label>
                                                    <input type="text" class="form-control" id="surat_retur" name="surat_retur" value="<?= $row["surat_retur"]; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="article_name">Article Name</label>
