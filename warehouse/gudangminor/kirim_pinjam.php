...
if (!empty($data_gudangminor)) {
    ...
    $query_insert_barangpinjam = "INSERT INTO barangpinjam (tgl_brg_keluar, surat_retur, article_name, size, stock, dipinjam, idstock_minor) 
                              VALUES (NOW(), '', '$article_name', '$size', '', '', $idstock_minor)";
