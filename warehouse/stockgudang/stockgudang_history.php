...
// Query untuk mengambil data dari tabel stockgudang_history dengan urutan terbaru
$sql = "SELECT * FROM stockgudang_history ORDER BY edit_timestamp DESC";
...
if ($rowCount > 10) {
    $deleteSql = "DELETE FROM stockgudang_history ORDER BY edit_timestamp ASC LIMIT " . ($rowCount - 10);
...
<head>
    ...
    <title>History Stock Gudang</title>
</head>

<body>
    <h1 style="text-align: center;">History Stock Gudang</h1>
