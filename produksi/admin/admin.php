...
$adminproduksi = query("SELECT * FROM admin_produksi");
...
$adminproduksi = query("SELECT * FROM admin_produksi LIMIT $start, $limit");
$totalRecords = count(query("SELECT * FROM admin_produksi"));
...
<body>
    ...
    <div class="content">
        <div class="container-fluid">
            <!------- HEADER ------->
            <h1 class="page-header">Data Admin Produksi
                <br><br><br>
                ...
                <div class="table-responsive">
                    <table id="data-table" class="table table-hover">
                        ...
                        <?php foreach ($adminproduksi as $row) : ?>
