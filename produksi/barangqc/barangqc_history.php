...
$sql = "SELECT * FROM barangqc_history ORDER BY edit_timestamp DESC";
...
if ($rowCount > 10) {
    $deleteSql = "DELETE FROM barangqc_history ORDER BY edit_timestamp ASC LIMIT " . ($rowCount - 10);
...
<head>
    ...
    <title>History Barang QC</title>
</head>

<body>
    <h1 style="text-align: center;">History Barang QC</h1>
