...
$barangqc = query("SELECT * FROM barangqc");

// Pagination
$limit = 20;
$page = isset($_GET['page']) ? $_GET['page'] : 1;
$totalRecords = count(query("SELECT * FROM barangqc"));
...
if (!empty($search)) {
    ...
    $search_filter = "WHERE 
        ...
        LOWER(sj_for_qc) LIKE '%$search%' OR
...
$query = "SELECT * FROM barangqc $date_filter $search_filter ORDER BY idbarang_qc DESC LIMIT $start, $limit";
$barangqc = query($query);

// Hitung jumlah total records untuk pencarian yang difilter dan rentang tanggal
$totalRecordsSearchDateFilter = count(query("SELECT * FROM barangqc $date_filter $search_filter"));
$totalPagesSearchDateFilter = ceil($totalRecordsSearchDateFilter / $limit);

// Hitung jumlah total catatan untuk filtered date range
$totalRecordsDateFilter = count(query("SELECT * FROM barangqc $date_filter"));
...
<body>
    ...
    <div class="content">
        <div class="container-fluid">
            <!------- HEADER ------->
            <h1 class="page-header">Inventori Pengeluaran Barang QC
                <br><br><br>
                ...
                <div class="row" style="margin-top: 5px; margin-bottom: 5px">
                    ...
                    <div class="col-md-2 text-right">
                        ...
                        <a href="barangqc_history.php" class="btn btn-info mx-2" target="_blank">History</a>
                    </div>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="proses_tambah.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="sj_for_qc">SJ For QC</label>
                                        <input type="text" class="form-control" id="sj_for_qc" name="sj_for_qc" required>
                                    </div>
                ...
                <div class="table-responsive">
                    <table id="data-table" class="table table-hover">
                        ...
                        <?php foreach ($barangqc as $row) : ?>
                            ...
                            <tr class="data-row">
                                <td><input type="checkbox" class="print-checkbox" data-id="<?= $row["idbarang_qc"]; ?>">
                                </td>
                                <td><?= $i; ?></td>
                                ...
                                <td>
                                    <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                        <button type="button" class="btn btn-warning delete-button" data-id="<?= $row["idbarang_qc"]; ?>">Hapus</button>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ubahBarangModal<?= $row["idbarang_qc"]; ?>" data-id="<?= $row["idbarang_qc"]; ?>" data-page="<?= $page; ?>">Ubah</button>
                                        <button type="button" class="btn btn-success copy-button" data-id="<?= $row["idbarang_qc"]; ?>">Copy</button>
                                    </div>
                                </td>
                            </tr>

                            <div class="modal fade" id="ubahBarangModal<?= $row["idbarang_qc"]; ?>" tabindex="-1" role="dialog" aria-labelledby="ubahBarangModalLabel<?= $row["idbarang_qc"]; ?>" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title" id="ubahBarangModalLabel<?= $row["idbarang_qc"]; ?>">
                                                Ubah Barang</h3>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="proses_ubah.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="id" value="<?= $row["idbarang_qc"]; ?>">
                                                <div class="form-group">
                                                    <label for="tgl_brg_masuk">Tanggal Barang Masuk</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="vendor">Vendor</label>
                                                    <select class="form-control" id="vendor" name="vendor" required onchange="checkOtherOptionVendor(this);">
                                                        <option value="<?= $row["vendor"]; ?>" <?= ($row["vendor"] == $row["vendor"]) ? "selected" : ""; ?>>
                                                            <?= $row["vendor"]; ?>
                                                        </option>
                                                        <option value="Alia Digital Printex" <?= ($row["vendor"] == "Alia Digital Printex") ? "selected" : ""; ?>>
                                                            Alia Digital Printex
                                                        </option>
                                                        <option value="Atfemale" <?= ($row["vendor"] == "Atfemale") ? "selected" : ""; ?>>
                                                            Atfemale
                                                        </option>
                                                        <option value="Atmosfira Dekatama" <?= ($row["vendor"] == "Atmosfira Dekatama") ? "selected" : ""; ?>>
                                                            Atmosfira Dekatama
                                                        </option>
                                                        <option value="Baju Kertas" <?= ($row["vendor"] == "Baju Kertas") ? "selected" : ""; ?>>
                                                            Baju Kertas
                                                        </option>
                                                        <option value="Bandanaira" <?= ($row["vendor"] == "Bandanaira") ? "selected" : ""; ?>>
                                                            Bandanaira
                                                        </option>
                                                        <option value="Bu Citra" <?= ($row["vendor"] == "Bu Citra") ? "selected" : ""; ?>>
                                                            Bu Citra
                                                        </option>
                                                        <option value="Bu Dewi" <?= ($row["vendor"] == "Bu Dewi") ? "selected" : ""; ?>>
                                                            Bu Dewi
                                                        </option>
                                                        <option value="Bu Elis" <?= ($row["vendor"] == "Bu Elis") ? "selected" : ""; ?>>
                                                            Bu Elis
                                                        </option>
                                                        <option value="Bu Hany" <?= ($row["vendor"] == "Bu Hany") ? "selected" : ""; ?>>
                                                            Bu Hany
                                                        </option>
                                                        <option value="Bu Icha" <?= ($row["vendor"] == "Bu Icha") ? "selected" : ""; ?>>
                                                            Bu Icha
                                                        </option>
                                                        <option value="Bu Kartika" <?= ($row["vendor"] == "Bu Kartika") ? "selected" : ""; ?>>
                                                            Bu Kartika
                                                        </option>
                                                        <option value="Bu Linda" <?= ($row["vendor"] == "Bu Linda") ? "selected" : ""; ?>>
                                                            Bu Linda
                                                        </option>
                                                        <option value="Bu Lilis" <?= ($row["vendor"] == "Bu Lilis") ? "selected" : ""; ?>>
                                                            Bu Lilis
                                                        </option>
                                                        <option value="Bu Rini" <?= ($row["vendor"] == "Bu Rini") ? "selected" : ""; ?>>
                                                            Bu Rini
                                                        </option>
                                                        <option value="Bu Riri" <?= ($row["vendor"] == "Bu Riri") ? "selected" : ""; ?>>
                                                            Bu Riri
                                                        </option>
                                                        <option value="Bu Ussy" <?= ($row["vendor"] == "Bu Ussy") ? "selected" : ""; ?>>
                                                            Bu Ussy
                                                        </option>
                                                        <option value="Bu Yani" <?= ($row["vendor"] == "Bu Yani") ? "selected" : ""; ?>>
                                                            Bu Yani
                                                        </option>
                                                        <option value="Bu Yuli" <?= ($row["vendor"] == "Bu Yuli") ? "selected" : ""; ?>>
                                                            Bu Yuli
                                                        </option>
                                                        <option value="CV SBB" <?= ($row["vendor"] == "CV SBB") ? "selected" : ""; ?>>
                                                            CV SBB
                                                        </option>
                                                        <option value="Kensby Research Co." <?= ($row["vendor"] == "Kensby Research Co.") ? "selected" : ""; ?>>
                                                            Kensby Research Co.
                                                        </option>
                                                        <option value="Muara Global" <?= ($row["vendor"] == "Muara Global") ? "selected" : ""; ?>>
                                                            Muara Global
                                                        </option>
                                                        <option value="Ophie Rever" <?= ($row["vendor"] == "Ophie Rever") ? "selected" : ""; ?>>
                                                            Ophie Rever
                                                        </option>
                                                        <option value="Pak Edi" <?= ($row["vendor"] == "Pak Edi") ? "selected" : ""; ?>>
                                                            Pak Edi
                                                        </option>
                                                        <option value="Pak Giri" <?= ($row["vendor"] == "Pak Giri") ? "selected" : ""; ?>>
                                                            Pak Giri
                                                        </option>
                                                        <option value="Pak Sunar" <?= ($row["vendor"] == "Pak Sunar") ? "selected" : ""; ?>>
                                                            Pak Sunar
                                                        </option>
                                                        <option value="Pa Ohid" <?= ($row["vendor"] == "Pa Ohid") ? "selected" : ""; ?>>
                                                            Pa Ohid
                                                        </option>
                                                        <option value="Penjahit Rapi" <?= ($row["vendor"] == "Penjahit Rapi") ? "selected" : ""; ?>>
                                                            Penjahit Rapi
                                                        </option>
                                                        <option value="PT Jaya Mitra Kurnia" <?= ($row["vendor"] == "PT Jaya Mitra Kurnia") ? "selected" : ""; ?>>
                                                            PT Jaya Mitra Kurnia
                                                        </option>
                                                        <option value="PT Thonnamaz" <?= ($row["vendor"] == "PT Thonnamaz") ? "selected" : ""; ?>>
                                                            PT Thonnamaz
                                                        </option>
                                                        <option value="PT.SJS" <?= ($row["vendor"] == "PT.SJS") ? "selected" : ""; ?>>
                                                            PT.SJS
                                                        </option>
                                                        <option value="RB Manufacturing" <?= ($row["vendor"] == "RB Manufacturing") ? "selected" : ""; ?>>
                                                            RB Manufacturing
                                                        </option>
                                                        <option value="Rumah Renza" <?= ($row["vendor"] == "Rumah Renza") ? "selected" : ""; ?>>
                                                            Rumah Renza
                                                        </option>
                                                        <option value="Sakh Konveksi" <?= ($row["vendor"] == "Sakh Konveksi") ? "selected" : ""; ?>>
                                                            Sakh Konveksi
                                                        </option>
                                                        <option value="Three and Me" <?= ($row["vendor"] == "Three and Me") ? "selected" : ""; ?>>
                                                            Three and Me
                                                        </option>
                                                        <option value="OTHER" <?= ($row["vendor"] == "OTHER") ? "selected" : ""; ?>>
                                                            Other
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group" id="otherVendorInput">
                                                    ...
                                                    <input class="form-control" type="text" id="otherVendor" name="otherVendor" placeholder="Pilih Other Pada Dropdown Untuk Memasukkan Vendor Lainnya">
                                                </div>
                                                <script>
                                                ...
                                                <div class="form-group">
                                                    <label for="sj_for_qc">SJ For QC</label>
                                                    <input type="text" class="form-control" id="sj_for_qc" name="sj_for_qc" value="<?= $row["sj_for_qc"]; ?>" required>
                                                </div>
