                            ...
                            <div class="modal-body">
                                ...
                                <form action="proses_tambah.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="stock_hasilpayet" name="stock_hasilpayet" pattern="[0-9]*" required>
                                    </div>
                                    <div class="form-group">
                ...
                <div class="table-responsive">
                    <table id="data-table" class="table table-hover">
                        ...
                        <?php foreach ($baranginpayet as $row) : ?>
                            ...
                            <tr class="data-row">
                                <td><input type="checkbox" class="print-checkbox" data-id="<?= $row["idbarang_inpayet"]; ?>">
                                </td>
                                <td><?= $i; ?></td>
                                ...
                                <td>
                                    <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                        ...
                                        <form action="kirim_qc.php" method="post" style="margin: 0;">
                                            <input type="hidden" name="idbarang_inpayet" value="<?= $row["idbarang_inpayet"]; ?>">
                                ...
                                <td>
                                    <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                        <button type="button" class="btn btn-warning delete-button" data-id="<?= $row["idbarang_inpayet"]; ?>">Hapus</button>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ubahBarangModal<?= $row["idbarang_inpayet"]; ?>" data-id="<?= $row["idbarang_inpayet"]; ?>" data-page="<?= $page; ?>">Ubah</button>
                            ...
                            <div class="modal fade" id="ubahBarangModal<?= $row["idbarang_inpayet"]; ?>" tabindex="-1" role="dialog" aria-labelledby="ubahBarangModalLabel<?= $row["idbarang_inpayet"]; ?>" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title" id="ubahBarangModalLabel<?= $row["idbarang_inpayet"]; ?>">
                                                Ubah Barang</h3>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="proses_ubah.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label for="stock_hasilpayet">Stock Hasil Payet</label>
                                                    <input type="number" class="form-control" id="stock_hasilpayet" name="stock_hasilpayet" pattern="[0-9]*" value="<?= $row["stock_hasilpayet"]; ?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="totalstock">Total Stock Masuk</label>
