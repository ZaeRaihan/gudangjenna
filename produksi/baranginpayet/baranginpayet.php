...
$baranginpayet = query("SELECT * FROM baranginpayet");

// Pagination
$limit = 20;
$page = isset($_GET['page']) ? $_GET['page'] : 1;
$totalRecords = count(query("SELECT * FROM baranginpayet"));
...
$query = "SELECT * FROM baranginpayet $date_filter $search_filter ORDER BY idbarang_inpayet DESC LIMIT $start, $limit";
$baranginpayet = query($query);

// Hitung jumlah total records untuk pencarian yang difilter dan rentang tanggal
$totalRecordsSearchDateFilter = count(query("SELECT * FROM baranginpayet $date_filter $search_filter"));
$totalPagesSearchDateFilter = ceil($totalRecordsSearchDateFilter / $limit);

// Hitung jumlah total catatan untuk filtered date range
$totalRecordsDateFilter = count(query("SELECT * FROM baranginpayet $date_filter"));
...
<body>
    ...
    <div class="content">
        <div class="container-fluid">
            <!------- HEADER ------->
            <h1 class="page-header">Inventori Barang In Payet
                <br><br><br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="" method="GET" class="form-inline">
                            ...
                            <a href="baranginpayet.php" class="btn btn-warning mx-2">Clear</a>
                        </form>
                ...
                <div class="row" style="margin-top: 5px; margin-bottom: 5px">
                    ...
                    <div class="col-md-2 text-right">
                        ...
                        <a href="baranginpayet_history.php" class="btn btn-info mx-2" target="_blank">History</a>
                    </div>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="proses_tambah.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="sj_for_vendor">SJ For Vendor Payet</label>
                                    ...
                                    <div class="form-group">
                                        <label for="stock_inpayet">Stock In Payet</label>
                                        <input type="number" class="form-control" id="stock_inpayet"
                                            name="stock_inpayet" pattern="[0-9]*">
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_payet">Vendor Payet</label>
                                        <select class="form-control" id="vendor_payet" name="vendor_payet" required
                                            onchange="checkLainnya('vendor_payet')">
                                        ...
                                        <input type="text" class="form-control mt-2" id="vendor_payet_input"
                                            name="vendor_payet_input" style="display: none;"
                                            placeholder="Masukkan Vendor Payet">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="sj_from_vendor">SJ From Vendor Payet</label>
                                        <input type="text" class="form-control" id="sj_from_vendor"
                                            name="sj_from_vendor">
                                    </div>
                                    <div class="form-group">
                                        <label for="stock_hasilpayet">Stock Hasil Payet</label>
                                        <input type="number" class="form-control" id="stock_hasilpayet"
                                            name="stock_hasilpayet" pattern="[0-9]*">
                                    </div>
                                    <div class="form-group">
                ...
                <div class="table-responsive">
                    <table id="data-table" class="table table-hover">
                        ...
                        <?php foreach ($baranginpayet as $row) : ?>

                        <tr class="data-row">
                            <td><input type="checkbox" class="print-checkbox"
                                    data-id="<?= $row["idbarang_inpayet"]; ?>">
                            </td>
                            <td><?= $i; ?></td>
                            ...
                            <td>
                                <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                    ...
                                    <form action="kirim_qc.php" method="post" style="margin: 0;">
                                        <input type="hidden" name="idbarang_inpayet"
                                            value="<?= $row["idbarang_inpayet"]; ?>">
                            ...
                            <td>
                                <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                    <button type="button" class="btn btn-warning delete-button"
                                        data-id="<?= $row["idbarang_inpayet"]; ?>">Hapus</button>
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#ubahBarangModal<?= $row["idbarang_inpayet"]; ?>"
                                        data-id="<?= $row["idbarang_inpayet"]; ?>"
                                        data-page="<?= $page; ?>">Ubah</button>
                                    <button type="button" class="btn btn-success copy-button"
                                        data-id="<?= $row["idbarang_inpayet"]; ?>">Copy</button>
                                </div>
                            </td>
                        </tr>

                        <div class="modal fade" id="ubahBarangModal<?= $row["idbarang_inpayet"]; ?>" tabindex="-1"
                            role="dialog" aria-labelledby="ubahBarangModalLabel<?= $row["idbarang_inpayet"]; ?>"
                            aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title"
                                            id="ubahBarangModalLabel<?= $row["idbarang_inpayet"]; ?>">
                                            Ubah Barang</h3>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="proses_ubah.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="id" value="<?= $row["idbarang_inpayet"]; ?>">
                                            <div class="form-group">
                                                <label for="tgl_brg_keluar">Tanggal Barang Keluar</label>
                                                <input type="date" class="form-control" id="tgl_brg_keluar"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="stock_inpayet"
                                                    name="stock_inpayet" pattern="[0-9]*"
                                                    value="<?= $row["stock_inpayet"]; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="vendor_payet">Vendor Payet</label>
                                                <select class="form-control" id="vendor_payet" name="vendor_payet"
                                                    required onchange="checkOtherOptionVendor_payet(this);">
                                                    <option value="<?= $row["vendor_payet"]; ?>"
                                                        <?= ($row["vendor_payet"] == $row["vendor_payet"]) ? "selected" : ""; ?>>
                                                        <?= $row["vendor_payet"]; ?>
                                                    </option>
                                                    <option value="Alia Digital Printex"
                                                        <?= ($row["vendor_payet"] == "Alia Digital Printex") ? "selected" : ""; ?>>
                                                        Alia Digital Printex
                                                    </option>
                                                    <option value="Atfemale"
                                                        <?= ($row["vendor_payet"] == "Atfemale") ? "selected" : ""; ?>>
                                                        Atfemale
                                                    </option>
                                                    <option value="Atmosfira Dekatama"
                                                        <?= ($row["vendor_payet"] == "Atmosfira Dekatama") ? "selected" : ""; ?>>
                                                        Atmosfira Dekatama
                                                    </option>
                                                    <option value="Baju Kertas"
                                                        <?= ($row["vendor_payet"] == "Baju Kertas") ? "selected" : ""; ?>>
                                                        Baju Kertas
                                                    </option>
                                                    <option value="Bandanaira"
                                                        <?= ($row["vendor_payet"] == "Bandanaira") ? "selected" : ""; ?>>
                                                        Bandanaira
                                                    </option>
                                                    <option value="Bu Citra"
                                                        <?= ($row["vendor_payet"] == "Bu Citra") ? "selected" : ""; ?>>
                                                        Bu Citra
                                                    </option>
                                                    <option value="Bu Dewi"
                                                        <?= ($row["vendor_payet"] == "Bu Dewi") ? "selected" : ""; ?>>
                                                        Bu Dewi
                                                    </option>
                                                    <option value="Bu Elis"
                                                        <?= ($row["vendor_payet"] == "Bu Elis") ? "selected" : ""; ?>>
                                                        Bu Elis
                                                    </option>
                                                    <option value="Bu Hany"
                                                        <?= ($row["vendor_payet"] == "Bu Hany") ? "selected" : ""; ?>>
                                                        Bu Hany
                                                    </option>
                                                    <option value="Bu Icha"
                                                        <?= ($row["vendor_payet"] == "Bu Icha") ? "selected" : ""; ?>>
                                                        Bu Icha
                                                    </option>
                                                    <option value="Bu Kartika"
                                                        <?= ($row["vendor_payet"] == "Bu Kartika") ? "selected" : ""; ?>>
                                                        Bu Kartika
                                                    </option>
                                                    <option value="Bu Linda"
                                                        <?= ($row["vendor_payet"] == "Bu Linda") ? "selected" : ""; ?>>
                                                        Bu Linda
                                                    </option>
                                                    <option value="Bu Lilis"
                                                        <?= ($row["vendor_payet"] == "Bu Lilis") ? "selected" : ""; ?>>
                                                        Bu Lilis
                                                    </option>
                                                    <option value="Bu Rini"
                                                        <?= ($row["vendor_payet"] == "Bu Rini") ? "selected" : ""; ?>>
                                                        Bu Rini
                                                    </option>
                                                    <option value="Bu Riri"
                                                        <?= ($row["vendor_payet"] == "Bu Riri") ? "selected" : ""; ?>>
                                                        Bu Riri
                                                    </option>
                                                    <option value="Bu Ussy"
                                                        <?= ($row["vendor_payet"] == "Bu Ussy") ? "selected" : ""; ?>>
                                                        Bu Ussy
                                                    </option>
                                                    <option value="Bu Yani"
                                                        <?= ($row["vendor_payet"] == "Bu Yani") ? "selected" : ""; ?>>
                                                        Bu Yani
                                                    </option>
                                                    <option value="Bu Yuli"
                                                        <?= ($row["vendor_payet"] == "Bu Yuli") ? "selected" : ""; ?>>
                                                        Bu Yuli
                                                    </option>
                                                    <option value="CV SBB"
                                                        <?= ($row["vendor_payet"] == "CV SBB") ? "selected" : ""; ?>>
                                                        CV SBB
                                                    </option>
                                                    <option value="Kensby Research Co."
                                                        <?= ($row["vendor_payet"] == "Kensby Research Co.") ? "selected" : ""; ?>>
                                                        Kensby Research Co.
                                                    </option>
                                                    <option value="Muara Global"
                                                        <?= ($row["vendor_payet"] == "Muara Global") ? "selected" : ""; ?>>
                                                        Muara Global
                                                    </option>
                                                    <option value="Ophie Rever"
                                                        <?= ($row["vendor_payet"] == "Ophie Rever") ? "selected" : ""; ?>>
                                                        Ophie Rever
                                                    </option>
                                                    <option value="Pak Edi"
                                                        <?= ($row["vendor_payet"] == "Pak Edi") ? "selected" : ""; ?>>
                                                        Pak Edi
                                                    </option>
                                                    <option value="Pak Giri"
                                                        <?= ($row["vendor_payet"] == "Pak Giri") ? "selected" : ""; ?>>
                                                        Pak Giri
                                                    </option>
                                                    <option value="Pak Sunar"
                                                        <?= ($row["vendor_payet"] == "Pak Sunar") ? "selected" : ""; ?>>
                                                        Pak Sunar
                                                    </option>
                                                    <option value="Pa Ohid"
                                                        <?= ($row["vendor_payet"] == "Pa Ohid") ? "selected" : ""; ?>>
                                                        Pa Ohid
                                                    </option>
                                                    <option value="Penjahit Rapi"
                                                        <?= ($row["vendor_payet"] == "Penjahit Rapi") ? "selected" : ""; ?>>
                                                        Penjahit Rapi
                                                    </option>
                                                    <option value="PT Jaya Mitra Kurnia"
                                                        <?= ($row["vendor_payet"] == "PT Jaya Mitra Kurnia") ? "selected" : ""; ?>>
                                                        PT Jaya Mitra Kurnia
                                                    </option>
                                                    <option value="PT Thonnamaz"
                                                        <?= ($row["vendor_payet"] == "PT Thonnamaz") ? "selected" : ""; ?>>
                                                        PT Thonnamaz
                                                    </option>
                                                    <option value="PT.SJS"
                                                        <?= ($row["vendor_payet"] == "PT.SJS") ? "selected" : ""; ?>>
                                                        PT.SJS
                                                    </option>
                                                    <option value="RB Manufacturing"
                                                        <?= ($row["vendor_payet"] == "RB Manufacturing") ? "selected" : ""; ?>>
                                                        RB Manufacturing
                                                    </option>
                                                    <option value="Rumah Renza"
                                                        <?= ($row["vendor_payet"] == "Rumah Renza") ? "selected" : ""; ?>>
                                                        Rumah Renza
                                                    </option>
                                                    <option value="Sakh Konveksi"
                                                        <?= ($row["vendor_payet"] == "Sakh Konveksi") ? "selected" : ""; ?>>
                                                        Sakh Konveksi
                                                    </option>
                                                    <option value="Three and Me"
                                                        <?= ($row["vendor_payet"] == "Three and Me") ? "selected" : ""; ?>>
                                                        Three and Me
                                                    </option>
                                                    <option value="OTHER"
                                                        <?= ($row["vendor_payet"] == "OTHER") ? "selected" : ""; ?>>
                                                        Other
                                                    </option>
                                                </select>
                                            </div>
