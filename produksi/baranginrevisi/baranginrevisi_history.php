...
$sql = "SELECT * FROM baranginrevisi_history ORDER BY edit_timestamp DESC";
...
if ($rowCount > 10) {
    $deleteSql = "DELETE FROM baranginrevisi_history ORDER BY edit_timestamp ASC LIMIT " . ($rowCount - 10);
...
<head>
    ...
    <title>History Barang In Revisi</title>
</head>

<body>
    <h1 style="text-align: center;">History Barang In Revisi</h1>
    <table class="table table-hover">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>" . $row['size'] . "</td>";
            echo "<td>" . $row['stock_inrevisi'] . "</td>";
            echo "<td>" . $row['stock_hasilrevisi'] . "</td>";
            echo "<td>" . $row['vendor_revisi'] . "</td>";
