...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $idbarang_insewing = $_POST['id'];
    $page = $_POST['page'];
    $result = ubahBarang($_POST, $idbarang_insewing);
    if ($result > 0) {
        echo "<script>alert('Data Barang berhasil diubah!');</script>";
        echo "<script>window.location.href = 'baranginsewing.php?page=$page';</script>"; // Redirect kembali ke halaman admin
    } else {
