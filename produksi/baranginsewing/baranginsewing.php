                                ...
                                <form action="proses_tambah.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="stock_insewing"
                                            name="stock_insewing" pattern="[0-9]*" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="stock_hasilsewing"
                                            name="stock_hasilsewing" pattern="[0-9]*" required>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <form action="proses_ubah.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="stock_insewing"
                                                    ...
                                                    value="<?= $row["stock_insewing"]; ?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="vendor_sewing">Vendor</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="stock_hasilsewing"
                                                    ...
                                                    value="<?= $row["stock_hasilsewing"]; ?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="status">Status</label>
                                                <select class="form-control" id="status" name="status" required>
