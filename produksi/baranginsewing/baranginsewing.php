                                ...
                                <form action="proses_tambah.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="vendor_sewing" name="vendor_sewing" required
                                            onchange="checkLainnya('vendor_sewing')">
                                        ...
                                        <input type="text" class="form-control mt-2" id="vendor_sewing_input"
                                            name="vendor_sewing_input" style="display: none;"
                                            placeholder="Masukkan Vendor Sewing">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                    ...
                                    <form action="kirim_vendor.php" method="post" style="margin: 0;">
                                        ...
                                        <button type="submit" class="btn btn-info"
                                            onclick="return confirm('Apakah Anda ingin mengirim barang tersebut?');">Vendor</button>
                                    </form>
                                </div>
                            </td>
                            <td>
                                <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                    ...
                                    <button type="button" class="btn btn-success copy-button"
                                        data-id="<?= $row["idbarang_insewing"]; ?>">Copy</button>
                                </div>
                            </td>
                        </tr>

                        <div class="modal fade" id="ubahBarangModal<?= $row["idbarang_insewing"]; ?>" tabindex="-1"
                            role="dialog" aria-labelledby="ubahBarangModalLabel<?= $row["idbarang_insewing"]; ?>"
                            aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title"
                                            id="ubahBarangModalLabel<?= $row["idbarang_insewing"]; ?>">
                                            Ubah Barang</h3>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="proses_ubah.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="vendor_sewing">Vendor Sewing</label>
                                                <select class="form-control" id="vendor_sewing" name="vendor_sewing"
                                                    required onchange="checkOtherOptionVendor_sewing(this);">
                                                    <option value="<?= $row["vendor_sewing"]; ?>"
                                                        <?= ($row["vendor_sewing"] == $row["vendor_sewing"]) ? "selected" : ""; ?>>
                                                        <?= $row["vendor_sewing"]; ?>
                                                    </option>
                                                    <option value="Alia Digital Printex"
                                                        <?= ($row["vendor_sewing"] == "Alia Digital Printex") ? "selected" : ""; ?>>
                                                        Alia Digital Printex
                                                    </option>
                                                    <option value="Atfemale"
                                                        <?= ($row["vendor_sewing"] == "Atfemale") ? "selected" : ""; ?>>
                                                        Atfemale
                                                    </option>
                                                    <option value="Atmosfira Dekatama"
                                                        <?= ($row["vendor_sewing"] == "Atmosfira Dekatama") ? "selected" : ""; ?>>
                                                        Atmosfira Dekatama
                                                    </option>
                                                    <option value="Baju Kertas"
                                                        <?= ($row["vendor_sewing"] == "Baju Kertas") ? "selected" : ""; ?>>
                                                        Baju Kertas
                                                    </option>
                                                    <option value="Bandanaira"
                                                        <?= ($row["vendor_sewing"] == "Bandanaira") ? "selected" : ""; ?>>
                                                        Bandanaira
                                                    </option>
                                                    <option value="Bu Citra"
                                                        <?= ($row["vendor_sewing"] == "Bu Citra") ? "selected" : ""; ?>>
                                                        Bu Citra
                                                    </option>
                                                    <option value="Bu Dewi"
                                                        <?= ($row["vendor_sewing"] == "Bu Dewi") ? "selected" : ""; ?>>
                                                        Bu Dewi
                                                    </option>
                                                    <option value="Bu Elis"
                                                        <?= ($row["vendor_sewing"] == "Bu Elis") ? "selected" : ""; ?>>
                                                        Bu Elis
                                                    </option>
                                                    <option value="Bu Hany"
                                                        <?= ($row["vendor_sewing"] == "Bu Hany") ? "selected" : ""; ?>>
                                                        Bu Hany
                                                    </option>
                                                    <option value="Bu Icha"
                                                        <?= ($row["vendor_sewing"] == "Bu Icha") ? "selected" : ""; ?>>
                                                        Bu Icha
                                                    </option>
                                                    <option value="Bu Kartika"
                                                        <?= ($row["vendor_sewing"] == "Bu Kartika") ? "selected" : ""; ?>>
                                                        Bu Kartika
                                                    </option>
                                                    <option value="Bu Linda"
                                                        <?= ($row["vendor_sewing"] == "Bu Linda") ? "selected" : ""; ?>>
                                                        Bu Linda
                                                    </option>
                                                    <option value="Bu Lilis"
                                                        <?= ($row["vendor_sewing"] == "Bu Lilis") ? "selected" : ""; ?>>
                                                        Bu Lilis
                                                    </option>
                                                    <option value="Bu Rini"
                                                        <?= ($row["vendor_sewing"] == "Bu Rini") ? "selected" : ""; ?>>
                                                        Bu Rini
                                                    </option>
                                                    <option value="Bu Riri"
                                                        <?= ($row["vendor_sewing"] == "Bu Riri") ? "selected" : ""; ?>>
                                                        Bu Riri
                                                    </option>
                                                    <option value="Bu Ussy"
                                                        <?= ($row["vendor_sewing"] == "Bu Ussy") ? "selected" : ""; ?>>
                                                        Bu Ussy
                                                    </option>
                                                    <option value="Bu Yani"
                                                        <?= ($row["vendor_sewing"] == "Bu Yani") ? "selected" : ""; ?>>
                                                        Bu Yani
                                                    </option>
                                                    <option value="Bu Yuli"
                                                        <?= ($row["vendor_sewing"] == "Bu Yuli") ? "selected" : ""; ?>>
                                                        Bu Yuli
                                                    </option>
                                                    <option value="CV SBB"
                                                        <?= ($row["vendor_sewing"] == "CV SBB") ? "selected" : ""; ?>>
                                                        CV SBB
                                                    </option>
                                                    <option value="Kensby Research Co."
                                                        <?= ($row["vendor_sewing"] == "Kensby Research Co.") ? "selected" : ""; ?>>
                                                        Kensby Research Co.
                                                    </option>
                                                    <option value="Muara Global"
                                                        <?= ($row["vendor_sewing"] == "Muara Global") ? "selected" : ""; ?>>
                                                        Muara Global
                                                    </option>
                                                    <option value="Ophie Rever"
                                                        <?= ($row["vendor_sewing"] == "Ophie Rever") ? "selected" : ""; ?>>
                                                        Ophie Rever
                                                    </option>
                                                    <option value="Pak Edi"
                                                        <?= ($row["vendor_sewing"] == "Pak Edi") ? "selected" : ""; ?>>
                                                        Pak Edi
                                                    </option>
                                                    <option value="Pak Giri"
                                                        <?= ($row["vendor_sewing"] == "Pak Giri") ? "selected" : ""; ?>>
                                                        Pak Giri
                                                    </option>
                                                    <option value="Pak Sunar"
                                                        <?= ($row["vendor_sewing"] == "Pak Sunar") ? "selected" : ""; ?>>
                                                        Pak Sunar
                                                    </option>
                                                    <option value="Pa Ohid"
                                                        <?= ($row["vendor_sewing"] == "Pa Ohid") ? "selected" : ""; ?>>
                                                        Pa Ohid
                                                    </option>
                                                    <option value="Penjahit Rapi"
                                                        <?= ($row["vendor_sewing"] == "Penjahit Rapi") ? "selected" : ""; ?>>
                                                        Penjahit Rapi
                                                    </option>
                                                    <option value="PT Jaya Mitra Kurnia"
                                                        <?= ($row["vendor_sewing"] == "PT Jaya Mitra Kurnia") ? "selected" : ""; ?>>
                                                        PT Jaya Mitra Kurnia
                                                    </option>
                                                    <option value="PT Thonnamaz"
                                                        <?= ($row["vendor_sewing"] == "PT Thonnamaz") ? "selected" : ""; ?>>
                                                        PT Thonnamaz
                                                    </option>
                                                    <option value="PT.SJS"
                                                        <?= ($row["vendor_sewing"] == "PT.SJS") ? "selected" : ""; ?>>
                                                        PT.SJS
                                                    </option>
                                                    <option value="RB Manufacturing"
                                                        <?= ($row["vendor_sewing"] == "RB Manufacturing") ? "selected" : ""; ?>>
                                                        RB Manufacturing
                                                    </option>
                                                    <option value="Rumah Renza"
                                                        <?= ($row["vendor_sewing"] == "Rumah Renza") ? "selected" : ""; ?>>
                                                        Rumah Renza
                                                    </option>
                                                    <option value="Sakh Konveksi"
                                                        <?= ($row["vendor_sewing"] == "Sakh Konveksi") ? "selected" : ""; ?>>
                                                        Sakh Konveksi
                                                    </option>
                                                    <option value="Three and Me"
                                                        <?= ($row["vendor_sewing"] == "Three and Me") ? "selected" : ""; ?>>
                                                        Three and Me
                                                    </option>
                                                    <option value="OTHER"
                                                        <?= ($row["vendor_sewing"] == "OTHER") ? "selected" : ""; ?>>
                                                        Other
                                                    </option>
                                                </select>
                                            </div>
