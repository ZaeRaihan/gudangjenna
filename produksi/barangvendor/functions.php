...
function tambahBarang($data)
{
    ...
    ('$tgl_brg_masuk',  '$sj_from_vendor' ,'$launching_date', '$collection', '$article_name', '$size', '$stock', '$vendorToUse', '$status')";
...
function ubahBarang($data, $idbarang_vendor)
{
    ...
    article_name = '$article_name', size = '$size', stock = '$stock', vendor = '$vendor', status = '$status' WHERE idbarang_vendor = $idbarang_vendor";
