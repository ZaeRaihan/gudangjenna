                                ...
                                <td>
                                    <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                        ...
                                        <form action="kirim_qc.php" method="post" style="margin: 0;">
                                            <input type="hidden" name="idbarang_vendor" value="<?= $row["idbarang_vendor"]; ?>">
                                        ...
                                        <form action="kirim_payet.php" method="post" style="margin: 0;">
                                            <input type="hidden" name="idbarang_vendor" value="<?= $row["idbarang_vendor"]; ?>">
                                            <button type="submit" class="btn btn-warning" onclick="return confirm('Apakah Anda ingin mengirim barang tersebut?');">Payet</button>
                                        </form>
                                    </div>
                                </td>
                                <td>
                                    <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                        <button type="button" class="btn btn-warning delete-button" data-id="<?= $row["idbarang_vendor"]; ?>">Hapus</button>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ubahBarangModal<?= $row["idbarang_vendor"]; ?>" data-id="<?= $row["idbarang_vendor"]; ?>" data-page="<?= $page; ?>">Ubah</button>
                                        <button type="button" class="btn btn-success copy-button" data-id="<?= $row["idbarang_vendor"]; ?>">Copy</button>
                                    </div>
                                </td>
                            </tr>

                            <div class="modal fade" id="ubahBarangModal<?= $row["idbarang_vendor"]; ?>" tabindex="-1" role="dialog" aria-labelledby="ubahBarangModalLabel<?= $row["idbarang_vendor"]; ?>" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title" id="ubahBarangModalLabel<?= $row["idbarang_vendor"]; ?>">
                                                Ubah Barang</h3>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                            ...
                                            <form action="proses_ubah.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="status" name="status" required>
                                                        ...
                                                        <option value="QC" <?= ($row["status"] == "QC") ? "selected" : ""; ?>>QC
                                                        </option>
                                                        <option value="Payet" <?= ($row["status"] == "Payet") ? "selected" : ""; ?>>
                                                            Payet</option>
                                                    </select>
                                                </div>
