...
$sql = "SELECT * FROM barangvendor_history ORDER BY edit_timestamp DESC";
...
if ($rowCount > 10) {
    $deleteSql = "DELETE FROM barangvendor_history ORDER BY edit_timestamp ASC LIMIT " . ($rowCount - 10);
...
<head>
    ...
    <title>History Barang Vendor</title>
</head>

<body>
    <h1 style="text-align: center;">History Barang Vendor</h1>
