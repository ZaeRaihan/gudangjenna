...
$sql = "SELECT * FROM barang_minor_history ORDER BY edit_timestamp DESC";
...
if ($rowCount > 10) {
    $deleteSql = "DELETE FROM barang_minor_history ORDER BY edit_timestamp ASC LIMIT " . ($rowCount - 10);
...
<head>
    ...
    <title>History Barang Minor</title>
</head>

<body>
    <h1 style="text-align: center;">History Barang Minor</h1>
