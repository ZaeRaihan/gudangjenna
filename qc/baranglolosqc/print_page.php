...
$query = "SELECT * FROM barang_lolosqc WHERE idbarang_lolosqc IN (" . implode(',', $selectedRows) . ") ORDER BY idbarang_lolosqc DESC";
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col text-center">
                <h1 class="mt-3">Surat Jalan <br>Barang Lolos QC</h1>
            </div>
        </div>
    </div>
