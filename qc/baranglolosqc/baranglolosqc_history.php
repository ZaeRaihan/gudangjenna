...
// Query untuk mengambil data dari tabel  barang_lolosqc_history dengan urutan terbaru
$sql = "SELECT * FROM barang_lolosqc_history ORDER BY edit_timestamp DESC";
...
if ($rowCount > 10) {
    $deleteSql = "DELETE FROM  barang_lolosqc_history ORDER BY edit_timestamp ASC LIMIT " . ($rowCount - 10);
...
<head>
    ...
    <title>History Barang Lolos QC</title>
</head>

<body>
    <h1 style="text-align: center;">History Barang Lolos QC</h1>
