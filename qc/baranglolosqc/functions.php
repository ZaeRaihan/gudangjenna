...
function tambahBarang($data) {
    ...
    // Query tambah barang
    $query = "INSERT INTO barang_lolosqc (tgl_brg_masuk, launching_date, collection, article_name, size, stock, tgl_brg_keluar, sj_for_wh) VALUES
     ('$tgl_brg_masuk', '$launching_date', '$collection', '$article_name', '$size', '$stock', '$tgl_brg_keluar', '$sj_for_wh')";
