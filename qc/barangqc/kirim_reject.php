...
if (!empty($data_barangqc)) {
    ...
    if ($stok_dikirim <= $stock && $stok_dikirim > 0) {
        // Jika stok yang akan dikirim tidak melebihi stok yang ada pada barangqc dan jumlah stok yang dikirim lebih dari 0, lakukan pengiriman ke tabel barang_reject
