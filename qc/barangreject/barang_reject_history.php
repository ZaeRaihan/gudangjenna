...
$sql = "SELECT * FROM barang_reject_history ORDER BY edit_timestamp DESC";
...
if ($rowCount > 10) {
    $deleteSql = "DELETE FROM barang_reject_history ORDER BY edit_timestamp ASC LIMIT " . ($rowCount - 10);
...
<head>
    ...
    <title>History Barang Reject</title>
</head>

<body>
    <h1 style="text-align: center;">History Barang Reject</h1>
