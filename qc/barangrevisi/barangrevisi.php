...
<body>
    ...
    <div class="content">
        <div class="container-fluid">
            <!------- HEADER ------->
            <h1 class="page-header">Inventori Pengeluaran Barang Revisi
                <br><br><br>
                ...
                <div class="row" style="margin-top: 5px; margin-bottom: 5px">
                    ...
                    <div class="col-md-2 text-right">
                        ...
                        <a href="barangrevisi_history.php" class="btn btn-info mx-2" target="_blank">History</a>
                    </div>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="proses_tambah.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="vendor">Vendor Revisi</label>
                                        ...
                                        <input type="text" class="form-control mt-2" id="vendor_input" name="vendor_input" style="display: none;" placeholder="Masukkan Vendor Revisi">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="sj_for_produksi">SJ For Produksi</label>
                                        <input type="text" class="form-control" id="sj_for_produksi" name="sj_for_produksi" required>
                                    </div>
                ...
                <div class="table-responsive">
                    <table id="data-table" class="table table-hover">
                        ...
                        <?php foreach ($barangrevisi as $row) : ?>
                            ...
                            <tr class="data-row">
                                <td><input type="checkbox" class="print-checkbox" data-id="<?= $row["idbarang_revisi"]; ?>">
                                </td>
                                <td><?= $i; ?></td>
                                ...
                                <td>
                                    <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                        <button type="button" class="btn btn-warning delete-button" data-id="<?= $row["idbarang_revisi"]; ?>">Hapus</button>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ubahBarangModal<?= $row["idbarang_revisi"]; ?>" data-id="<?= $row["idbarang_revisi"]; ?>" data-page="<?= $page; ?>">Ubah</button>
                                        <button type="button" class="btn btn-success copy-button" data-id="<?= $row["idbarang_revisi"]; ?>">Copy</button>
                                    </div>
                                </td>
                            </tr>

                            <div class="modal fade" id="ubahBarangModal<?= $row["idbarang_revisi"]; ?>" tabindex="-1" role="dialog" aria-labelledby="ubahBarangModalLabel<?= $row["idbarang_revisi"]; ?>" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title" id="ubahBarangModalLabel<?= $row["idbarang_revisi"]; ?>">
                                                Ubah Barang</h3>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="proses_ubah.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="id" value="<?= $row["idbarang_revisi"]; ?>">
                                                <div class="form-group">
                                                    <label for="tgl_brg_masuk">Tanggal Barang Masuk</label>
                                                ...
                                                <div class="form-group" id="otherVendorInput">
                                                    <label for="otherVendor">Vendor Revisi Lainnya</label>
                                                    <input class="form-control" type="text" id="otherVendor" name="otherVendor" placeholder="Pilih Other Pada Dropdown Untuk Memasukkan Vendor Revisi Lainnya">
                                                </div>
                                                <script>
                                                ...
                                                <div class="form-group">
                                                    <label for="sj_for_produksi">SJ For Produksi</label>
                                                    <input type="text" class="form-control" id="sj_for_produksi" name="sj_for_produksi" value="<?= $row["sj_for_produksi"]; ?>" required>
                                                </div>
