                                ...
                                <form action="proses_tambah.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mt-2" id="vendor_input"
                                            name="vendor_input" style="display: none;"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="sj_for_produksi"
                                            name="sj_for_produksi" required>
                                    </div>
                            ...
                            <td>
                                <div class="btn-group text-center" style="display: flex; justify-content: center;">
                                    <button type="button" class="btn btn-warning delete-button"
                                        data-id="<?= $row["idbarang_revisi"]; ?>">Hapus</button>
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#ubahBarangModal<?= $row["idbarang_revisi"]; ?>"
                                        data-id="<?= $row["idbarang_revisi"]; ?>"
                                        data-page="<?= $page; ?>">Ubah</button>
                                    <button type="button" class="btn btn-success copy-button"
                                        data-id="<?= $row["idbarang_revisi"]; ?>">Copy</button>
                                </div>
                            </td>
                        </tr>

                        <div class="modal fade" id="ubahBarangModal<?= $row["idbarang_revisi"]; ?>" tabindex="-1"
                            role="dialog" aria-labelledby="ubahBarangModalLabel<?= $row["idbarang_revisi"]; ?>"
                            aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title"
                                            id="ubahBarangModalLabel<?= $row["idbarang_revisi"]; ?>">
                                            Ubah Barang</h3>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="proses_ubah.php" method="post" enctype="multipart/form-data">
                                            ...
                                            function checkOtherOptionVendor(select) {
                                                var otherVendorInput = document.getElementById(
                                                    "otherVendorInput");
                                            ...
                                            <div class="form-group">
                                                <label for="sj_for_produksi">SJ For Produksi</label>
                                                <input type="text" class="form-control" id="sj_for_produksi"
                                                    name="sj_for_produksi" value="<?= $row["sj_for_produksi"]; ?>"
                                                    required>
                                            </div>
