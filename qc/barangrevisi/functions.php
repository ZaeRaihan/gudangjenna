...
function tambahBarang($data)
{
    ...
    ('$tgl_brg_masuk', '$launching_date', '$collection', '$article_name', '$size', '$stock', '$vendor', '$tgl_brg_keluar', '$sj_for_produksi')";
...
function ubahBarang($data, $idbarang_revisi)
{
    global $db;
...
function getBarangById($idbarang_revisi)
{
    global $db;
    $query = "SELECT * FROM barangrevisi WHERE idbarang_revisi = $idbarang_revisi";
    $result = mysqli_query($db, $query);
...
function hapusBarang($id)
{
    ...
    // Query hapus barang
    $query = "DELETE FROM barangrevisi WHERE idbarang_revisi = $id";
    mysqli_query($db, $query);
    return mysqli_affected_rows($db);
}
