...
$sql = "SELECT * FROM barangrevisi_history ORDER BY edit_timestamp DESC";
...
if ($rowCount > 10) {
    $deleteSql = "DELETE FROM barangrevisi_history ORDER BY edit_timestamp ASC LIMIT " . ($rowCount - 10);
...
<head>
    ...
    <title>History Barang Revisi</title>
</head>

<body>
    <h1 style="text-align: center;">History Barang Revisi</h1>
    <table class="table table-hover">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>" . $row['sj_for_produksi'] . "</td>";
            echo "</tr>";
        }
        ?>
    </table>
