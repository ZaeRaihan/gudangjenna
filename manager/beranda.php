                            ...
                            <div class="col-xs-12">
                                <div class="dropdown text-center">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="./produksi/barangqc/barangqc.php" style="font-weight: 600;">BARANG
                                                QC</a></li>
                                        <li><a href="./produksi/baranginpayet/baranginpayet.php"
                                                style="font-weight: 600;">BARANG IN PAYET</a></li>
                                        <li><a href="./produksi/baranginsewing/baranginsewing.php"
                                                style="font-weight: 600;">BARANG IN SEWING</a></li>
                                        <li><a href="./produksi/baranginrevisi/baranginrevisi.php"
                                                style="font-weight: 600;">BARANG IN REVISI</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="dropdown text-center">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="./qc/baranglolosqc/baranglolosqc.php"
                                                style="font-weight: 600;">BARANG LOLOS QC</a></li>
                                        <li><a href="./qc/barangreject/barangreject.php"
                                                style="font-weight: 600;">BARANG REJECT</a></li>
                                        <li><a href="./qc/barangminor/barangminor.php" style="font-weight: 600;">BARANG
                                                MINOR</a></li>
                                        <li><a href="./qc/barangrevisi/barangrevisi.php"
                                                style="font-weight: 600;">BARANG REVISI</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="dropdown text-center">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="./wh/stockgudang/stockgudang.php" style="font-weight: 600;">STOCK
                                                GUDANG</a></li>
                                        <li><a href="./wh/gudangreject/gudangreject.php"
                                                style="font-weight: 600;">GUDANG BARANG REJECT</a></li>
                                        <li><a href="./wh/gudangminor/gudangminor.php" style="font-weight: 600;">GUDANG
                                                BARANG MINOR</a></li>
                                        <li><a href="./wh/barangkeluar/barangkeluar.php"
                                                style="font-weight: 600;">BARANG KELUAR</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
