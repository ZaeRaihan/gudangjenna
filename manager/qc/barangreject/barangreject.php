...
<body>
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="../baranglolosqc/baranglolosqc.php">BARANG LOLOS QC</a></li>
                            <li class="active"><a href="barangreject.php">BARANG REJECT</a></li>
                            <li><a href="../barangminor/barangminor.php">BARANG MINOR</a></li>
                            <li><a href="../barangrevisi/barangrevisi.php">BARANG REVISI</a></li>
                        </ul>
                    </li>
                    <li>
                        <a>
    ...
    <div class="content">
        <div class="container-fluid">
            <!------- HEADER ------->
            <h1 class="page-header">QC : Inventori Pengeluaran Barang Reject
                <br><br><br>
