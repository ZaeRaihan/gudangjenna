...
$adminmanager = query("SELECT * FROM admin_manager");
...
$adminmanager = query("SELECT * FROM admin_manager LIMIT $start, $limit");
$totalRecords = count(query("SELECT * FROM admin_manager"));
...
<head>
    ...
    <!-- tema css -->
    <link href="../../css/adminmanager.css" rel="stylesheet">
    <title>Manager</title>
</head>
...
<body>
    ...
    <div class="content">
        <div class="container-fluid">
            <!------- HEADER ------->
            <h1 class="page-header">Data Manager
                <br><br><br>
                ...
                <div class="table-responsive">
                    <table id="data-table" class="table table-hover">
                        ...
                        <?php foreach ($adminmanager as $row) : ?>
